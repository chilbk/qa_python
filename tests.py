...
class TestBooksCollector:
    ...
    # Проверяем, что книги с невалидными данными не сохраняются
    ...
    # Проверяет, что метод возвращает книги для детей
    ...
    # Проверяет, что метод возвращает книги только для детей
